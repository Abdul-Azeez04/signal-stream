...
import { ArrowLeft, ExternalLink, TrendingUp, Clock, Calendar } from "lucide-react";
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        <article className="animate-reveal" style={{ animationDelay: "80ms" }}>
          ...
          <div className="mb-4 flex flex-wrap items-center gap-3 text-sm">
            <span className={`inline-flex items-center rounded-md px-2.5 py-1 text-xs font-medium ${categoryStyles[signal.category]}`}>
